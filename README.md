...
for CSS cd into assets and run this command if you install Ruby installer
and if you know sass that will be great. before run this commad if you are on windows install this exe
https://github.com/oneclick/rubyinstaller2/releases/download/RubyInstaller-2.7.2-1/rubyinstaller-devkit-2.7.2-1-x64.exe
after install Run gem install sass in terminal.
